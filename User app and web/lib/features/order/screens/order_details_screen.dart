  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: GetBuilder<OrderController>(builder: (orderController) {
        ...
        double total = itemsPrice + addOns - discount! + (taxIncluded! ? 0 : tax!) + deliveryCharge! + deliveryTypeCharge - couponDiscount! + dmTips! + additionalCharge + extraPackagingCharge - referrerBonusAmount;
