...
class RestaurantService implements RestaurantServiceInterface {
  ...
  @override
  Future<RestaurantModel?> getRestaurantList(int offset, String filterBy, int topRated, int discount, int veg, int nonVeg, {bool fromMap = false, DataSourceEnum? source, FilterDataModel? filterDataModel}) async {
    return await restaurantRepositoryInterface.getList(offset: offset, filterBy: filterBy, topRated: topRated, discount: discount, veg: veg, nonVeg: nonVeg, fromMap: fromMap, source: source, filterDataModel: filterDataModel);
  }
  ...
  @override
  Future<List<Restaurant>?> getPopularRestaurantList({DataSourceEnum? source, FilterDataModel? filterDataModel}) async {
    return await restaurantRepositoryInterface.getRestaurantList(isPopular: true, source: source,filterDataModel: filterDataModel);
  }
